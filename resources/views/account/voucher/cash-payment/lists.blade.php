                    ...
                    <div class="card-body" style="display: block;">
                        <div class="table-responsive">         
                            <table class="table table-hover capitalize table-bordered" id="myTable">
                                <thead>
                                {{--    <th colspan="5"> <h1 class="text-center text-info">Account Ledger's List</h1></th>--}}
                                <tr>
                                    <th>#SL</th>
                                    <th>Date</th>
                                    <th>Journal No</th>
                                ...
                                @forelse ($cashPayments as $key=>$cp)
                                    <tr>
                                        <td>{{$key+1}}</td>
                                        <td>{{$cp->date }}</td>
                                        <td>{{$cp->journal_no}}</td>
                                        <td>{{$cp->event}}</td>
                                        <td>
                                            <a href="{{route('cash_payment_voucher.report',$cp->id)}}">
                                                <button type="button" class="btn btn-sm btn-outline-success" data-url="#" data-id="#">
                                                    Generate Voucher <i class="fas fa-folder-plus"></i>
                                                </button>
                                            </a>
                            
                                            {{-- <a class="far fa-edit btn-sm btn btn-primary" href="#"></a>
                                            <button type="button" class="erase btn btn-sm btn-danger far fa-trash-alt" data-url="#" data-id="#"></button> --}}
                                        </td>
                                    </tr>
                                @empty
