                            ...
                            <div class="card-body" style="display: block;">
                                <table class="table">
                                    ...
                                    <td width="33%">No :{{$transactions->journal_no}}</td>
                                        <td width="25%"></td>
                                        <td width="42%">Dated : {{$transactions->date}} </td>
                                    </tr>
                                </table>
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>
                                                    ...
                                                    <b>Trough :</b>
                                                        <ul>
                                                            @if(str_before($transactions->journalEntries->first()->note,'-')=='bank')
                                                                @forelse ($transactions->journalEntries as $jr)
                                                                    @if($jr->type==1)
                                                                        <li>{{ $jr->acchead->name }}</li>
                                                                    @endif
                                                                ...
                                                                @endforelse
                                                            @else
                                                            <li>{{str_before($transactions->journalEntries->first()->note,'-') }}</li>
                                                            @endif
                                                        </ul>
                                                    <b>On Account of :</b>
