        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-lg-3 col-6">
                    <!-- small box -->
                    <div class="small-box bg-{{settings('theme')}}">
                        <div class="inner">
                            <h3>{{$bankWithdrawns->sum('amount')}} 
                                {{-- <sup style="font-size: 20px"></sup> --}}
                            </h3>
                            <p>Today's Bank Withdrawn</p>
                        </div>
                        <div class="icon">
                ...
                <div class="col-lg-3 col-6">
                    ...
                    <div class="small-box bg-{{settings('theme')}}">
                        <div class="inner">
                            <h3>{{$bankDeposites->sum('amount')}} 
                                {{-- <sup style="font-size: 20px">%</sup> --}}
                            </h3>

                            <p>Today's Bank Diposite</p>
                        </div>
                        <div class="icon">
                ...
                <div class="col-lg-3 col-6">
                    ...
                    <div class="small-box bg-{{settings('theme')}}">
                        <div class="inner">
                            <h3>{{$cashPayments->sum('amount')}}</h3>

                            <p>Todays Cash Payments</p>
                        </div>
                        <div class="icon">
                ...
                <div class="col-lg-3 col-6">
                    ...
                    <div class="small-box bg-{{settings('theme')}}">
                        <div class="inner">
                            <h3>{{$cashReceipts->sum('amount')}}</h3>

                            <p>Todays Cash Receipts</p>
                        </div>
                        <div class="icon">
