...
<div class="login-box">
    <div class="login-logo">
        ...
        {{--<a href="{{ url('/') }}"><b>Smarty</b>Cabs</a>--}}
    </div>

    <!-- /.login-logo -->
{{--    <marquee style="font-family:Book Antiqua; color: #FFFFFF" bgcolor="#000080" scrolldelay="150">Ringer Accounts Solutions ...  Ringer Accounts Solutions ... </marquee>--}}

{{--    <h6 class="text-center p-2 bg-dark text-light">Welcome to Ringer Accounts Solutions </h6>--}}
    <div class="card">
