...
<ul class="navbar-nav" style="margin:auto">
    <li class="nav-item dropdown">
        ...
        <i class="fa fa-bank"></i><strong> {{ unit_name() ?? app_info()->company_name }}</strong>
            {{-- <span class="badge badge-danger navbar-badge">active</span> --}}
        </a>
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu bg-success">
            @forelse(unit_lists() as $unit)
            <a href="javascript:void" class="dropdown-item">
                <!-- Message Start -->
                <div class="media">
                    {{-- <img src="{{ asset('dist/img/user1-128x128.jpg') }}" alt="User Avatar" class="img-size-50 mr-3 img-circle"> --}}
                    <div class="media-body">
                        <h3 class="dropdown-item-title" onclick="set_unit({{ $unit->id }})">
                            {{ $unit->name }}
...
<ul class="navbar-nav ml-auto">
    ...
    <li class="nav-item dropdown" style="margin-top:4px;">
        ...
        <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
            <li class="user-header bg-{{settings('theme')}}">
                <p class="text-center">
            ...
            <!-- Menu Footer-->
            <li class="user-footer bg-{{settings('theme')}}">
                <div class="pull-left">
                    <a href="{{ action('UserController@show') }}" class="btn btn-{{settings('theme')}} btn-flat">Profile</a>
                </div>
                <div class="pull-right">
                    <a href="{{ route('logout') }}"
                       class="btn btn-{{settings('theme')}} btn-flat"
